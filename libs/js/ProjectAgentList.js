         ...
         success: function (data) {
            ...
            $.each(data, function (key, row) {
               $('#ESData').append('<div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">' +
                  ...
                  '<span id="c3chart">' + row._id.name + '</span></h5> <h5><span>' + row._id.project + '</span></h5>' +
                  '<div id="c3chart_gauge' + row._id.chart_name + '"></div> </div>' +
                  '<div class="card-footer-item card-footer-item-bordered">' +
                  '<div class="row"> <div class="col-xl-3 col-lg-3 col-md-3 col-sm-12 col-12">' +
                  '<label>Total Hours</label> <h5><span>' + row.total_hours + '</span></h5> </div>' +
                  '<div class="col-xl-3 col-lg-3 col-md-3 col-sm-12 col-12"> <label>Billable</label> <h5><span>' + row.billable_hours + '</span></h5></div>' +
                  '<div class="col-xl-3 col-lg-3 col-md-3 col-sm-12 col-12"> <label>Breaks</label> <h5><span>' + row.breaks + '</span></h5> </div>' +
                  '<div class="col-xl-3 col-lg-3 col-md-3 col-sm-12 col-12"><label>Flags</label><h5><span>' + row.non_billable_hours + '</span></h5>' +
                  '</div> </div> </div> </div> </div>');
